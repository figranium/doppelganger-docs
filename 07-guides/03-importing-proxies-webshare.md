# Importing Proxies into figranium: Webshare

figranium supports rotating through a list of proxies or using a single backconnect (rotating) proxy. This guide explains how to get your proxies from Webshare and import them correctly.
...
4. **Important: Check the format.** figranium's importer expects one of the following formats:
...
## 2. Importing into figranium

### Option A: Bulk Import (Recommended for lists)

1. Open figranium and go to **Settings** > **Proxies**.
2. Click the **Import** button.
3. Select the `.txt` file you downloaded from Webshare.
4. figranium will automatically parse the lines and add them to your list.
...
3. Check the **Rotating pool** box.
   - This tells figranium that this single address provides a pool of IPs.
