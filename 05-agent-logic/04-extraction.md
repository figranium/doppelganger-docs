...
If the page loads content dynamically (AJAX), ensure your task includes `wait` or `wait_selector` actions _before_ the extraction script runs. The script executes only after the last action completes.
